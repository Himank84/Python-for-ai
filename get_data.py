...
url = f"https://api.open-meteo.com/v1/forecast?latitude=28.70&longitude=77.10&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Delhi  Weather - Past 10 days')
plt.legend()
